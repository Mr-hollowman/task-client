    ...
    return (
        <form className="w-50" onSubmit={handleSubmit}>
            ...
            <div className="form-floating mb-3">
                ...
                <label htmlFor="floatingSelect">Project Type</label>
            </div>
            <div className="form-floating mb-3">
                ...
                <label htmlFor="floatingSelect">Project Tag</label>
            </div>
            <div className="form-floating mb-3">
                ...
                <label htmlFor="floatingInput">Start Price range</label>
            </div>
            <div className="form-floating mb-3">
                ...
                <label htmlFor="floatingInput">End Price range</label>
            </div>
            <div className="form-floating mb-3">
